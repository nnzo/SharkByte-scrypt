...
#if defined(NDEBUG)
# error "sharkbyte cannot be compiled without assertions."
#endif
...
int nStakeMinConfirmations = 600;
...
const string strMessageMagic = "sharkbyte Signed Message:\n";
...
{
    RenameThread("sharkbyte-loadblk");
